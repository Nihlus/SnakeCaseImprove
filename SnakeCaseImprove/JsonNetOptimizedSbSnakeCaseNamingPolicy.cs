...
public class JsonNetOptimizedSbSnakeCaseNamingPolicy : JsonNamingPolicy
{
        ...
        for (var i = 0; i < name.Length; i++)
            ...
            else if (char.IsUpper(name[i]))
            {
                ...
                char c;
                    ...
                    c = char.ToLower(name[i], CultureInfo.InvariantCulture);
#else
            ...
            {
                if (state == SeparatedCaseState.NewWord) sb.Append('_');
